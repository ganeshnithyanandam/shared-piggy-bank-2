...
sleep 4
curl -H "Content-Type: application/json" -X POST -d 199999 http://localhost:9080/api/contract/instance/$W1/endpoint/put &&
sleep 4
...
sleep 4
curl -H "Content-Type: application/json" -X POST -d 399999 http://localhost:9080/api/contract/instance/$W2/endpoint/put &&
sleep 4
...
sleep 4
curl -H "Content-Type: application/json" -X POST -d 900000 http://localhost:9080/api/contract/instance/$W2/endpoint/put
sleep 4
